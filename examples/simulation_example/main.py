...
class CameraNetwork:
    ...
    def get_y(self, rTNn):
        ...
        for cam in self._cams:
            y.append(cam.get_dir_vec(rTNn)[0:2])
        return y
    ...
    def process_y(self, y):
        ...
        for k, val in enumerate(combinations(y, 2)):
            ...
            h_c1 = get_homogeneous_line_from_point_and_direction(rC1Nn, y1)
            h_c2 = get_homogeneous_line_from_point_and_direction(rC2Nn, y2)
